 ...
 *         &lt;element name="RECOVERY" type="{http://earthdawn.de}RECOVERY_type"/>
 *         &lt;element name="UNCONSCIOUSNESS" type="{http://earthdawn.de}DEATH_type"/>
 *         &lt;element name="DEATH" type="{http://earthdawn.de}DEATH_type"/>
 *         &lt;element name="WOUNDS" type="{http://earthdawn.de}WOUND_type"/>
 *       &lt;/choice>
...
public class HEALTHType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "UNCONSCIOUSNESS", namespace = "http://earthdawn.de", type = JAXBElement.class),
        @XmlElementRef(name = "DEATH", namespace = "http://earthdawn.de", type = JAXBElement.class),
        @XmlElementRef(name = "WOUNDS", namespace = "http://earthdawn.de", type = JAXBElement.class),
        @XmlElementRef(name = "RECOVERY", namespace = "http://earthdawn.de", type = JAXBElement.class)
    })
