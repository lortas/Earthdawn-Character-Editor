 ...
 *       &lt;attribute name="bezeichnung" use="required" type="{http://earthdawn.de}disziplinlist_type" />
...
public class DISZIPLINType {
    ...
    protected DisziplinlistType bezeichnung;
    @XmlAttribute(required = true)
     ...
     *     
     */
    public DisziplinlistType getBezeichnung() {
        return bezeichnung;
    }
     ...
     *     
     */
    public void setBezeichnung(DisziplinlistType value) {
